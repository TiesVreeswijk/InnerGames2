...
// SplashScreen -> SplashScreen2 -> WelcomeScreen -> HomeScreenv2
void main() {
  runApp(MaterialApp(
    home: SplashScreen(),
  ));
...
/// Old navigation + code (commented out to prevent confusion, but keeping it here for reference as we build the new flow with the splash screens)
